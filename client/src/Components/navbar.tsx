...
export default function Navbar({ workspace, account }: { workspace: WorkspacesForUser | null, account: Account }) {
  ...
  return (
    <div>
      <nav className="flex-no-wrap relative flex w-full items-center justify-between bg-neutral-100 py-4 shadow-md shadow-black/5 dark:bg-neutral-600 dark:shadow-black/10 lg:flex-wrap lg:justify-start" data-te-navbar-ref>
